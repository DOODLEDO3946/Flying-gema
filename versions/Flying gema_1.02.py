...
while game:							# Start game menu
	...
	if pi:
		if joystickPS2.getResult() == 3:
			...
			settings()
var_to_save = [version, highscore_normal, Rrandomise, Grandomise, Rthing, Gthing, Bthing, Brandomise, shape, pointer, controls, backscore, fullscreen, hitboxes, specific_colouring, mode, highscore_time]
