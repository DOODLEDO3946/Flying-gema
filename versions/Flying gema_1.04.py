...
def startgame():			# create a function for the entire game
	...
	if shape == "triangle":
		...
		if not specific_colouring:
			pygame.draw.polygon(thing_surface, pygame.Color(Rthing, Gthing, Bthing), ((0, 10), (10, 10), (5, 0)), hollow)
		else:
			pygame.draw.polygon(thing_surface, pygame.Color(Rrandomise, Grandomise, Brandomise), ((0, 10), (10, 10), (5, 0)), hollow)
	start = time.time()
	...
	while running:
		...
		if shape == "square":
			if not specific_colouring:
				pygame.draw.rect(screen, pygame.Color(Rthing, Gthing, Bthing), thing, hollow)
			else:
				pygame.draw.rect(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), thing, hollow)
		if timer == framerate:
			if shape == "triangle":
				if not specific_colouring:
					pygame.draw.polygon(thing_surface, pygame.Color(Rthing, Gthing, Bthing), ((0, 10), (10, 10), (5, 0)), hollow)
		...
		if direction[0] and not direction[2] and not direction[3]:		# Up
			...
			if animations and shape == "triangle":
				screen.blit((pygame.transform.rotate(thing_surface, -22.5)), (thing.x, thing.y - 5))
			...
			if animations and shape == "triangle": 
				if not specific_colouring:
					pygame.draw.rect(screen, pygame.Color(Rthing//2, Gthing//2, Bthing//2, 128), thing)
				else:
		...
		if not animations:
			...
			if not specific_colouring:
				pygame.draw.circle(screen, pygame.Color(Rthing, Gthing, Bthing), ((thing.x + 5), (thing.y + 5)), 5, hollow)
			else:
				pygame.draw.circle(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), ((thing.x + 5), (thing.y + 5)), 5, hollow)
...
def customize():
	global shape, Rrandomise, Grandomise, Brandomise, Rthing, Gthing, Bthing, specific_colouring, hollow
	screen.fill((R, G, B))
	while True:
		tmp = randint(205, 255)
		if Rrandomise:
		...
		if not specific_colouring:			# Draw the shapes onto the screen
			pygame.draw.circle(screen, pygame.Color(Rthing, Gthing, Bthing), (100, 245), 5, hollow)
			pygame.draw.rect(screen, pygame.Color(Rthing, Gthing, Bthing), Rect(535, 240, 10, 10), hollow)
			pygame.draw.polygon(screen, pygame.Color(Rthing, Gthing, Bthing), ((315, 45), (325, 45), (320, 35)), hollow)
		else:
			pygame.draw.circle(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), (100, 245), 5, hollow)
			pygame.draw.rect(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), Rect(535, 240, 10, 10), hollow)
			pygame.draw.polygon(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), ((315, 45), (325, 45), (320, 35)), hollow)
	...
	while True:
		...
		if pprint("midtop", "Hollow", 24, whiteColour, (320, 10), True).collidepoint(pos) and click:
			hollow = 1
			break
		if not specific_colouring:			# Draw the shapes onto the top of the screen
			if shape == "circle":
				pygame.draw.circle(screen, pygame.Color(Rthing, Gthing, Bthing), (320, 41.5), 5, 1)
				pygame.draw.circle(screen, pygame.Color(Rthing, Gthing, Bthing), (320, 438.5), 5)
			elif shape == "square":
				pygame.draw.rect(screen, pygame.Color(Rthing, Gthing, Bthing), Rect(315, 36.5, 10, 10), 1)
				pygame.draw.rect(screen, pygame.Color(Rthing, Gthing, Bthing), Rect(315, 433.5, 10, 10))
			else:
				pygame.draw.polygon(screen, pygame.Color(Rthing, Gthing, Bthing), ((315, 45), (325, 45), (320, 35)), 1)
				pygame.draw.polygon(screen, pygame.Color(Rthing, Gthing, Bthing), ((315, 445), (325, 445), (320, 435)))
		else:
			if shape == "circle":
				pygame.draw.circle(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), (320, 41.5), 5, 1)
				pygame.draw.circle(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), (320, 438.5), 5)
			elif shape == "square":
				pygame.draw.rect(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), Rect(315, 36.5, 10, 10), 1)
				pygame.draw.rect(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), Rect(315, 433.5, 10, 10))
			else:
				pygame.draw.polygon(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), ((315, 45), (325, 45), (320, 35)), 1)
				pygame.draw.polygon(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), ((315, 445), (325, 445), (320, 435)))
		pygame.display.update()
		fpsClock.tick(5)
		for event in pygame.event.get():
			if event.type == KEYDOWN:
	...
	while True:
		...
		if shape == "square":
			if not specific_colouring:
				pygame.draw.rect(screen, pygame.Color(Rthing, Gthing, Bthing), Rect(315, 220, 10, 10), hollow)
			else:
				pygame.draw.rect(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), Rect(315, 220, 10, 10), hollow)
		elif shape == "circle":
			if not specific_colouring:
				pygame.draw.circle(screen, pygame.Color(Rthing, Gthing, Bthing), (320, 230), 5, hollow)
			else:
				pygame.draw.circle(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), (320, 230), 5, hollow)
		elif shape == "triangle":
			if not specific_colouring:
				pygame.draw.polygon(screen, pygame.Color(Rthing, Gthing, Bthing), ((315, 230), (325, 230), (320, 220)), hollow)
			else:
				pygame.draw.polygon(screen, pygame.Color(Rrandomise, Grandomise, Brandomise), ((315, 230), (325, 230), (320, 220)), hollow)
...
def settings():
	...
	while True:
		screen.fill((R, G, B))
		distance_moved -= (distance_moved-320)/5
		pos = pygame.mouse.get_pos()
		click = pygame.mouse.get_pressed()[0]
		if pi:												  # Write stuff on screen
			pprint("midtop", "Hold button / e or", 24, whiteColour, (320, 240))
...
if os.path.exists(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'flying_gema_save.pkl')):
	try:
		...
		if not isinstance(save[0], float):
			highscore_normal, Rrandomise, Grandomise, Brandomise, Rthing, Gthing, Bthing, shape, pointer, controls, backscore, fullscreen, hitboxes, specific_colouring = save
		elif save[0] == 1.02:
			Null, highscore_normal, Rrandomise, Grandomise, Brandomise, Rthing, Gthing, Bthing, shape, pointer, controls, backscore, fullscreen, hitboxes, specific_colouring, mode, highscore_time = save
		elif save[0] == version or 1.03:
			Null, highscore_normal, Rrandomise, Grandomise, Brandomise, Rthing, Gthing, Bthing, shape, pointer, controls, backscore, fullscreen, hitboxes, specific_colouring, mode, highscore_time, hollow = save
		else:
			highscore_normal, Rrandomise, Grandomise, Brandomise, Rthing, Gthing, Bthing, shape, pointer, controls, backscore, fullscreen, hitboxes, specific_colouring, mode, highscore_time = save
	...
	if shape == "triangle":
		...
		thing_surface.fill(pygame.SRCALPHA)
		if not specific_colouring:
			pygame.draw.circle(thing_surface, pygame.Color(Rthing, Gthing, Bthing), (5, 5), 5, hollow)
		else:
			pygame.draw.circle(thing_surface, pygame.Color(Rrandomise, Grandomise, Brandomise), (5, 5), 5, hollow)
	elif shape == "square":
		if not specific_colouring:
			pygame.draw.rect(thing_surface, pygame.Color(Rthing, Gthing, Bthing), Rect(0, 0, 10, 10), hollow)
		else:
			pygame.draw.rect(thing_surface, pygame.Color(Rrandomise, Grandomise, Brandomise), Rect(0, 0, 10, 10), hollow)
	pygame.display.set_icon(thing_surface)  
else:
	highscore_time = 0
	highscore_normal = 0
...
def pause():
	...
	while True:
		...
		transition_x += ((transition_goto_x-transition_x)/10) * 60/framerate
...
while game:							# Start game menu
	...
	if pprint("midtop", "Start game", 22, whiteColour, (startgame_x, 240), True).collidepoint(pos) and click:
		...
		settings_y = 640
		fpsClock = pygame.time.Clock()
	if pprint("midtop", "Customize", 22, whiteColour, (customize_x, 240), True).collidepoint(pos) and click:
		customize()
		startgame_x = 660
		customize_x = -40
		settings_y = 640
	...
	if pi:
		if joystickPS2.getResult() == 3:
			...
			settings()
var_to_save = [version, highscore_normal, Rrandomise, Grandomise, Rthing, Gthing, Bthing, Brandomise, shape, pointer, controls, backscore, fullscreen, hitboxes, specific_colouring, mode, highscore_time, hollow]
if (os.path.exists(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'flying_gema_save.pkl')) and save != var_to_save) or not os.path.exists(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'flying_gema_save.pkl')):
	print("Saving...")
